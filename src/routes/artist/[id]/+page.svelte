<script>
  ...
  function getArtistLastFmUrl() {
    if (artistInfo?.lastFmUrl) return artistInfo.lastFmUrl;
    if (!artist) return "";
    // Construct fallback: https://www.last.fm/music/Artist+Name
    const encodedName = artist.name.replace(/ /g, "+");
    return `https://www.last.fm/music/${encodedName}`;
  }
</script>
    ...
    >
      <div class="relative group">
        ...
        <button
          ...
          class="absolute bottom-2 right-2 bg-black/40 text-white border border-[var(--border-glass)] rounded-full p-3 hover:bg-black/60 transition-all shadow-lg flex items-center justify-center backdrop-blur-md z-10 {artist.starred
        ...
        <div class="flex items-center gap-2 text-[var(--text-secondary)]">
          ...
          {#if !artistInfo || !artistInfo.biography}
            ...
            <div class="flex items-center gap-3">
              <a
                href={getArtistLastFmUrl()}
                target="_blank"
                rel="noopener noreferrer"
                class="text-[var(--text-secondary)] hover:text-[#D51007] transition-all hover:scale-110 flex items-center justify-center p-1"
              ...
              {#if artistInfo?.musicBrainzId}
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-[var(--text-secondary)] hover:text-[#EB743B] transition-all hover:scale-110 flex items-center justify-center p-1"
      ...
      <div class="container mx-auto">
        <div class="flex items-center gap-4 mt-6 mb-6">
          ...
          <div class="flex items-center gap-2">
            <button
              onclick={playArtist}
              class="bg-[var(--accent)] text-[var(--accent-fg)] rounded-full p-2 hover:scale-105 transition-transform shadow-md flex items-center justify-center"
            ...
            <button
              ...
              class="bg-[var(--bg-card)] text-[var(--text-primary)] border border-[var(--border-glass)] rounded-full p-2 hover:bg-[var(--bg-hover)] transition-colors shadow-md flex items-center justify-center"
