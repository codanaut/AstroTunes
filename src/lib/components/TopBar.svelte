...
<!-- TOP BAR -->
<header
    class="h-16 bg-[var(--bg-sidebar)] backdrop-blur-xl border-b border-[var(--border-primary)] flex items-center justify-center px-4 md:px-8 shrink-0 sticky top-0 z-40 gap-4"
>
    <button
        onclick={onToggle}
